...
## Projects
[Github Projects](https://github.com/orgs/SWEN90016-2025-SM1/projects/5)

## Contribution
If you commit changes on **main branch**, please run `git pull --rebase` before you push your changes.

If you commit changes on **sprint branch**, please merge the changes to the main branch locally by running `git checkout main && git pull --rebase && git merge <sprint-branch-name>`, and then push your changes.
